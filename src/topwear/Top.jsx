...
export const Top = () => {
  ...
  const filteredProduct=PRODUCTS.slice(0,20).filter((product)=>
    ...
    <> 
      ...
      <div className={`top1 ${isFilterActive ? 'active' : ''}`}>
        <div className='top11'>
          ...
          <span className='filter-jacket' onClick={()=>typeCategory("jacket")}>Jackets & Coats</span>
          <span className='filter-jacket' onClick={()=>typeCategory("shirt")}>Shirts</span>
          <span className='filter-jacket' onClick={()=>typeCategory("tshirt")}>T-shirt</span>
          <span className='filter-jacket' onClick={()=>typeCategory("hoodie")}>Hoodies</span>
            ...
            <div className='hide'>
                <div className='jhg'>
                  <div className='jhg1'>
                    ...
                    <span className='netplay' onClick={()=>brandCategory("DILLINGER")}>Dillinger</span>
                    <span className='netplay' onClick={()=>brandCategory("SNITCH")} >Snitch</span>
                  ...
                  <div className='jhg2'>
                    ...
                    <div onClick={()=>colorCategory("yellow")} className='chamba'><div className='color5'></div><span className='netplay1'>Yellow</span></div>
